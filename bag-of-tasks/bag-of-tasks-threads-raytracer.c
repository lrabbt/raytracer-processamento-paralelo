/* Trabalho de Sistemas Operacionais I (usando threads)
...
#include <string.h>
#include <float.h>
#include <pthread.h> //Biblioteca incluída
...
struct varFromLoop{ //Estrutura com os parametros usados na função executada pelas threads
	int samples;
	int s;
	float rcp_samples;
	camera c;
